...
BOOST_AUTO_TEST_SUITE(test_suite_ip_filter)
    ...
    BOOST_AUTO_TEST_CASE(test_process_incorrect) {
        ...
        std::string incorrect_in_data1 {"67.232.81.208\t2\t1\n"
                                        "1.29.168.152\t2\t2\n"
                                        "123.125.223\t3\t4\n"  ///incorrect
                                        "185.46.85.78\t5\n"
        };
        ...
        std::string incorrect_in_data2 { "67.232.81.208\t2\t1\n"
                                         "1.29.168.152\t2\t2\n"
        ...
        std::string incorrect_in_data3 { "67.232.81.208\t2\t1\n"
                                         "1.29.168.152\t2\t2\n"
                                         "123.125.a.23\t3\t4\n"  ///incorrect
                                         "185.46.85.78\t5\n"
        };
        ...
        std::string incorrect_in_data4 { "67.232.81.208\t2\t1\n"
                                         "1.29.168.152\t2\t2\n"
                                         "123.125.256.23\t3\t4\n" ///incorrect
                                         "185.46.85.78\t5\n"
        };
        ...
        std::string incorrect_in_data5 { "67.232.81.208\t2\t1\n"
                                         "1.29.168.152\t2\t2\n"
                                         "123.125.-1.23.31\t3\t4\n" ///incorrect
                                         "185.46.85.78\t5\n"
        };
